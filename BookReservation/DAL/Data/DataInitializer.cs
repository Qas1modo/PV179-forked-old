    ...
    public static class DataInitializer
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            Reservation rent2 = new()
            {
                ...
                CanceledAt = new DateTime(2021, 11, 5),
                RentedAt = null,
                ReturnedAt = null,
                LoanPeriod = 20,
            ...
            Reservation rent4 = new()
            {
                ...
                CanceledAt = new DateTime(2021, 1, 5),
                RentedAt = null,
                ReturnedAt = null,
                LoanPeriod = 120,
            ...
            Reservation rent39 = new()
            {
                Id = 40,
                UserId = 1,
                BookId = 11,
                ReservedAt = new DateTime(2022, 12, 12),
                RentedAt = null,
                ReturnedAt = null,
                LoanPeriod = 20,
                State = RentState.Reserved,
            ...
            modelBuilder.Entity<Reservation>().HasData(rent39);
            ///////////////////////////////////////////////////
